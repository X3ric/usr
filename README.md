...
### Install
 ...
 ```
curl -s https://raw.githubusercontent.com/X3ric/usr/master/.local/share/bin/archx -o archx &&
sudo chmod +x archx && ./archx
```
select "Configs" when done exit 

run `archx` and go in Installer > PicomX if you want to install [picom-x](https://github.com/X3ric/picom).
