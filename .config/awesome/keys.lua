...
keys.globalkeys = gears.table.join(         
    ...
    awful.key({ altkey }, "v" , function ()  awful.spawn.with_shell('sleep 1 && current=$(xkb-switch -p);setxkbmap us -option caps:none && xdotool type "$(xclip -o)" && setxkbmap $current') end,{description = "input copy" , group = "X-awesome"}),
